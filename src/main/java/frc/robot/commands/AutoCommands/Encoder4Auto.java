...
public class Encoder4Auto extends SequentialCommandGroup {
  public Encoder4Auto(Arm arm, Drivetrain drive, double drivepower, VirtualFourBar bar, Claw claw, double clawpower, Turret turret, Pigeon2 gyro) {
    addCommands(
      Commands.sequence(
        ...
        new DriveBackAuto(drive, -drivepower).withTimeout(0.04)
